/*
  # Fix Match Setup Validation

  1. Changes
    - Fix ambiguous match_id reference in validate_match_setup function
    - Improve parameter naming to avoid conflicts
    - Add better error handling
    - Ensure proper validation of match squads
